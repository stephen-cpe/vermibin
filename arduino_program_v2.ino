...
#define WLAN_SSID       "Vermibin"           // cannot be longer than 32 characters!
#define WLAN_PASS       "passwordchanged"
// Security can be WLAN_SEC_UNSEC, WLAN_SEC_WEP, WLAN_SEC_WPA or WLAN_SEC_WPA2
#define WLAN_SECURITY   WLAN_SEC_WPA2



#define SPRINKLER            8 //digital Pin 8
#define ONE_WIRE_BUS         2 //digital Pin 2
#define PELTIER              6 //digital Pin 6
...
{                
          ...
          moisture = constrain(moisture,200,900); // limit analogRead from range of 200 to 900
          moisture = map(moisture, 200, 900, 100, 0); // analogRead of a very wet condition of the soil is 200, and 900 for a very dry condition
          //get it in terms of percentage (0 = wet, 900 = dry)
         // String moistPercent = String((int) moisture) + "%";re
          water_level = digitalRead(44) + digitalRead(42) + digitalRead(40) + digitalRead(38) + digitalRead(36);
        /*  lcd.setCursor(0,0);
          lcd.print("Soil: ");
          lcd.setCursor(7,0);
          lcd.print(moisture);
          ...
          lcd.print("   C");*/
          automate();
          String request = "GET "+ repository + "sensor.php?temp=" + temperature + "&soil=" + moisture  + "&water=" + water_level + " HTTP/1.0\r\nConnection: close\r\n\r\n";
